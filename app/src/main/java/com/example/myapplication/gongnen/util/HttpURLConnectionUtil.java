package com.example.myapplication.gongnen.util;
...
public class HttpURLConnectionUtil {
	  ...
	  */
	  public String doGET (String uri, String param ) throws Exception {
	   ...
	   */
	  public static String doPOST2(String uri, String param, Map<String,String> headers ) throws Exception {
